...
gulp.task('insert', function(){
    gulp.src(['app/styles/skins/default/color-vars-body.css',
              'app/styles/skins/default/color-vars.css'])
        .pipe(insert.append('</style>'))
        .pipe(insert.prepend("<style is=\"custom-style\">"));
});

gulp.task('rename', function () {
    gulp.src(['app/styles/skins/default/*.css'])
        .pipe($.rename('*.html'))
        .pipe(gulp.dest('app/styles/skins/default/'));    
});
